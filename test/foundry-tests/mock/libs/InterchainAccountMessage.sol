...
library InterchainAccountMessage {
    ...
    function encodeCommitment(address _owner, bytes32 _ism, bytes32 _commitment, bytes32 _userSalt)
        internal
        pure
        returns (bytes memory)
    {
        return encodeCommitment(TypeCasts.addressToBytes32(_owner), _ism, _commitment, _userSalt);
    }

    function encodeCommitment(bytes32 _owner, bytes32 _ism, bytes32 _commitment, bytes32 _userSalt)
        internal
        pure
        returns (bytes memory)
    {
        return abi.encode(_owner, _ism, _commitment, _userSalt);
    }
     ...
     */
    function decodeCommitment(bytes calldata _message) internal pure returns (bytes32, bytes32, bytes32, bytes32) {
        return abi.decode(_message, (bytes32, bytes32, bytes32, bytes32));
    }
     ...
     * @return Formatted message body
     */
    function encode(address _owner, bytes32 _ism, CallLib.Call[] calldata _calls, bytes32 _userSalt)
        internal
        pure
        returns (bytes memory)
    {
        return encode(TypeCasts.addressToBytes32(_owner), _ism, _calls, _userSalt);
    }
     ...
     * @return Formatted message body
     */
    function encode(bytes32 _owner, bytes32 _ism, CallLib.Call[] calldata _calls, bytes32 _userSalt)
        internal
        pure
        returns (bytes memory)
    {
     ...
     * @return The array of calls
     */
    function decode(bytes calldata _message) internal pure returns (bytes32, bytes32, CallLib.Call[] memory, bytes32) {
        return abi.decode(_message, (bytes32, bytes32, CallLib.Call[], bytes32));
    }
